...
{
    [TCustomParametersDrawer(typeof(TPerlinNoiseNode))]
    public class TPerlinNoiseNodeParamsDrawer : TParametersDrawer
    {
        ...
        {
            TPerlinNoiseNode n = target as TPerlinNoiseNode;
