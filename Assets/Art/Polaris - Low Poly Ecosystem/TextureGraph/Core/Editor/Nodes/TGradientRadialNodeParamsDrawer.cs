...
{
    [TCustomParametersDrawer(typeof(TGradientRadialNode))]
    public class TGradientRadialNodeParamsDrawer : TParametersDrawer
    {
        ...
        {
            TGradientRadialNode n = target as TGradientRadialNode;
