...
namespace Pinwheel.TextureGraph
{
    [TNodeMetadata(
        Title = "Invert",
        CreationMenu = "Filter/Invert",
        Icon = "TextureGraph/NodeIcons/Invert",
        Documentation = "https://docs.google.com/document/d/1kDkFHAmuMNFTbfnBpYPkjw99CrVvUNr8_gFAJH2o-7s/edit#heading=h.88qt7b62w0c9")]
    public class TInvertNode : TAbstractTextureNode
    {
        public class TConst
        {
            public static readonly string SHADER = "Hidden/TextureGraph/Invert";
