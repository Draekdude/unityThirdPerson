...
namespace Pinwheel.TextureGraph
{
    [TNodeMetadata(
        ...
        CreationMenu = "Transformation/Polar To Cartesian",
        Icon = "TextureGraph/NodeIcons/PolarToCartesian",
        Documentation = "https://docs.google.com/document/d/1kDkFHAmuMNFTbfnBpYPkjw99CrVvUNr8_gFAJH2o-7s/edit#heading=h.obkjy9h3qjxt")]
    public class TPolarToCartesianNode : TAbstractTextureNode
    {
        public class TConst
        {
            public static readonly string SHADER = "Hidden/TextureGraph/PolarToCartesian";
